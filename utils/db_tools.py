...
def call_api(query: str) -> Dict[str, Any]:
    ...
    url = "http://192.168.0.71:8000/execute-query"
    params = {"query": query}
...
db_query_tool = {
    ...
    "description": "A tool to execute SQL queries against the database, retrieve results, and save them to CSV files. The tool returns metadata about the query results rather than the full dataset, which is saved to a CSV file. The metadata includes file path, row count, column names, and a small sample of the data.",
